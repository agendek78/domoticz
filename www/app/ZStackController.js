define(['app'], function (app) {
	app.controller('ZStackController', ['$scope', '$rootScope', '$location', '$http', '$interval', function ($scope, $rootScope, $location, $http, $interval) {
        ...
        ShowNodes = function ()
        {
            ...
            $.ajax({
                ...
                error: function (xhr, ajaxOptions, thrownError) {
                    alert("Problem retrieving ZStack nodes!");
                }
            });
        }
